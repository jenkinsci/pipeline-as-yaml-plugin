 ...
 */
public class PipelineAsYamlCpsScmFlowDefinition extends CpsScmFlowDefinition {
     ...
     */
    public PipelineAsYamlCpsScmFlowDefinition(SCM scm, String scriptPath, boolean lightweight) {
     ...
     * @param scriptPath Path of the yaml file in SVM
     */
    public PipelineAsYamlCpsScmFlowDefinition(SCM scm, String scriptPath) {
        super(scm, scriptPath);
    }
